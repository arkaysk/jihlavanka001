...
apps=("$@"); [ ${#apps[@]} -gt 0 ] || apps=(subory nastavenia monitor aplikacie zariadenia heidelberg barista zivatapeta instalator netznak kapsavyrez nahlad aichat plocha greeter)
fail=0
for a in "${apps[@]}"; do
